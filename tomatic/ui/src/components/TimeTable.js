...
function TimeTable(props) {
    const {grid, setCell, getCell, addColumn, removeColumn, showPenalties, showOverloads} = props
        ...
        return (
            <div className='graella'>
                ...
                <ul className='overloads'>
                    {grid.overload? [] : <li>'La graella no te sobrecarregues apuntades'</li>}
    ...
    return (
        ...
        <Tooltip title="Afegir una línia">
            <Fab size="medium" color="primary" aria-label="add" position='TopRight'>
                <AddIcon onClick={AddTurn} />
            </Fab>
        </Tooltip>
        <Tooltip title="Esborrar última línia">
            <Fab size="medium" color="primary" aria-label="remove" position='TopRight'>
